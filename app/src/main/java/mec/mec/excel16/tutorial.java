...
public class tutorial extends AppCompatActivity {
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position){
                case 0:
                    tp = tutorialFragment.newInstance(R.layout.welcome_fragment01);
                    break;
                case 1:
                    tp = tutorialFragment.newInstance(R.layout.welcome_fragment02);
                    break;
                case 2:
                    tp = tutorialFragment.newInstance(R.layout.welcome_fragment03);
                    break;
                case 3:
                    tp = tutorialFragment.newInstance(R.layout.welcome_fragment5);
                    break;
            }
